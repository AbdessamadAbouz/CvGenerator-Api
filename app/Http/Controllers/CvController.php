...
class CvController extends Controller
{
    public function store(Request $request) {
        ...
        $validator = Validator::make($request->all(), [
            'personal_info_id' => 'required|exists:personal_infos',
		...
		$skills_are_valid = $competence_ids->reduce(function ($truth, $skill_id) use ($user) {
            $skill = Competence::find($skill_id);
            if(! $skill) {
                return false;
            }
            return $truth && $skill->user_id == $user->id ;
        }, true);
        ...
        //
        $experience_ids = collect($request->input('competence_ids'));
        ...
        //
        $formation_ids = collect($request->input('competence_ids'));
        ...
        //
        $langue_ids = collect($request->input('competence_ids'));
